const CardSkeleton = () => {
  return (
    // bg-neutral-800
    <div className="w-64 h-80 border dark:border-gray-700 rounded-2xl text-gray-900 p-4 flex flex-col items-start justify-center gap-3 hover:shadow-xl hover:shadow-theme transition-shadow dark:text-white animate-pulse">
      <div className="w-56 h-40 bg-gray-300 rounded-2xl"></div>
      <div className="">
