...
const Card = ({ title, category, thumbnail, slug, updatedAt, createdBy }) => {
  ...
  return (
    // bg-neutral-800
    <div
      className="w-[14rem] md:w-[16rem] lg:w-[16rem] h-80 border dark:border-gray-700 rounded-2xl text-gray-900 p-4 flex flex-col items-start justify-center gap-3 hover:shadow-xl hover:shadow-theme transition-shadow dark:text-white cursor-pointer card overflow-hidden"
      onClick={() => navigate(`/blog/${slug}`)}
    >
      <div className="w-42 md:w-52 lg:w-56 h-40 bg-gray-300 rounded-2xl">
        <img
